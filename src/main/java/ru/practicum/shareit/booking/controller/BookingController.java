...
public class BookingController {
    ...
    public Collection<BookingDto> findAllByUserId(@RequestHeader("X-Sharer-User-Id") Long userId,
        ...
        Collection<BookingDto> bookingDtos = bookingService.findBookingsByItemOwnerId(userId, state, from, size);
    ...
    public Collection<BookingDto> findByUserIdAndState(@RequestHeader("X-Sharer-User-Id") Long userId,
        ...
        Collection<BookingDto> bookingDtos = bookingService.findByUserIdAndState(userId, state, from, size);
